...
--Char 1
INSERT INTO character (maxHp, ap, ad, klasse, name, description) VALUES (4500, 2, 80, 'TANK', 'KV-1S', 'DER KV-1S ist ein sowjetischer TANK der Stufe 6' );
...
--Char 2
INSERT INTO character (maxHp, ap, ad, klasse, name, description) VALUES (4000, 2, 100, 'TANK', 'T-90', 'Der T-90 ist ein Tank der russischen Armee, welcher vom Verteidigungsministerium der Russischen Föderation 1992 eingeführt wurde.' );
...
-- Char 3
INSERT INTO character (maxHp, ap, ad, klasse, name, description) VALUES (4200, 4, 80, 'TANK', 'Ariete', 'Italienischer KampfTank, aktuell gibt es 140 der Art in Italien' );
...
--Char 4
INSERT INTO character (maxHp, ap, ad, klasse, name, description) VALUES (600, 0, 80, 'DPS', 'Kalaschnikow', 'Sowjetischer Damage Dealer; Entwikelt 1946 einer der meistbenutzer Damage Dealer' );
...
--Char 5
INSERT INTO character (maxHp, ap, ad, klasse, name, description) VALUES (500, 0, 90, 'DPS', 'Ar-15', 'ArmaLite 15, developed in US, good for armor penetration' );
...
--Char 6
INSERT INTO character (maxHp, ap, ad, klasse, name, description) VALUES (600, 0, 80, 'DPS', 'MP-5', 'ist eine 9 x 19 mm Parabellum-Maschinenpistole in den 1960er Jahren vomIngenieuren des deutschen Kleinwaffenherstellers Heckler & Koch entwickelt.' );
...
--Char 7
INSERT INTO character (maxHp, ap, ad, klasse, name, description) VALUES (400, 3, 20, 'SUP', 'Mercy', 'hat keinen Frieden gegen Gegner' );
...
--Char 8
INSERT INTO character (maxHp, ap, ad, klasse, name, description) VALUES (400, 3, 20, 'SUP', 'HEILER', 'Einer der effizientesern HEILER aus DEUTSCHLAND für besten HEIL und SCHILD immer  EINSTAZBREREIT um dich und deine STAFFEL zu BESCHÜTZEN!' );
...
--Char 9
INSERT INTO character (maxHp, ap, ad, klasse, name, description) VALUES (400, 3, 20, 'SUP', 'Sage', 'bo' );
